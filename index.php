...
<body>
    ...
    <main>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sticky-top border-end" style="width: 230px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto mt-5">
                <li class="nav-item">
                    <a href="index.php?view=alerts" class="nav-link <?php the_active_view('inbox');?>">
  ...
  <path d="M4.98 4a.5.5 0 0 0-.39.188L1.54 8H6a.5.5 0 0 1 .5.5 1.5 1.5 0 1 0 3 0A.5.5 0 0 1 10 8h4.46l-3.05-3.812A.5.5 0 0 0 11.02 4H4.98zm-1.17-.437A1.5 1.5 0 0 1 4.98 3h6.04a1.5 1.5 0 0 1 1.17.563l3.7 4.625a.5.5 0 0 1 .106.374l-.39 3.124A1.5 1.5 0 0 1 14.117 13H1.883a1.5 1.5 0 0 1-1.489-1.314l-.39-3.124a.5.5 0 0 1 .106-.374l3.7-4.625z"></path>
                ...
                <li class="nav-item">
                    <a href="index.php?view=alerts" class="nav-link <?php the_active_view('ignored');?>">
                ...
                <li class="nav-item">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-2 bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
                ...
                $labels = DataAccess::get_db_entries(
                ...
                <li class="nav-item">
                    <a href="index.php?view=alerts&label=<?php echo $label->meta_name;?>" class="nav-link <?php the_active_view($label->meta_name);?>">
