    ...
    <main>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sticky-top border-end" style="width: 230px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto mt-5">
                ...
                $labels =  DataAccess::get_db_entries('meta', $filtered_to_labels);
                ...
                <li class="nav-item">
                    <a href="index.php?view=alerts&label=<?php echo $label->meta_name;?>" class="nav-link <?php the_active_view($label->meta_name);?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-2 bi bi-bookmark" viewBox="0 0 16 16">
