...
<div class="btn-group btn-group-sm mb-2" role="group" aria-label="Report Filter">
    ...
    <a class="btn btn-outline-secondary remove-filter-button" href="actions/queue_report_filter_change.php?report_id=<?php echo $report_id .'&filter_type='. $filter_type . '&filter_value='. $filter_value . '&filter_id=' . $filter_id; ?>">
