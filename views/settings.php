        ...
        <section id="properties">
            ...
            <div class="border-bottom px-2 py-3">
                <p class="h5 m-0"> 
                    ...
                    <a class="icon-link float-end" style="--bs-link-hover-color-rgb: 25, 135, 84;" href="index.php?view=property_editor&id=<?php echo $property->id;?>">
            ...
            <a class="btn btn-primary mt-3" href="index.php?view=property_editor">Add Property</a>
        </section>
