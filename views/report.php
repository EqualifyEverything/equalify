            ...
            <div class="mb-2">
                ...
                <a class="row text-body py-2 border-bottom" href="index.php?view=notice&id=">
                    ...
                    <span class="col-1" aria-label="Total Notices">
                        ...
                        47 <span class="badge rounded-pill bg-secondary">+32%<span class="visually-hidden">Change from last month</span></span>
                    </span>
                </a>
                <a class="row text-body py-2 border-bottom" href="index.php?view=notice&id=">
                    <span class="col-7">
                    ...
                    <span class="col-1" aria-label="Total Notices">
                        <!-- Add notice if change is over 5% from previous month -->
                        67 <span class="badge rounded-pill bg-secondary">-18%<span class="visually-hidden">Change from last month</span></span>
                    </span>
                </a>
                <a class="row text-body py-2 border-bottom" href="index.php?view=notice&id=">
                    <span class="col-7">
                ...
                <a class="row text-body py-2 border-bottom" href="index.php?view=notice&id=">
                    ...
                    <span class="col-1" aria-label="Total Notices">
                        <!-- Add notice if change is over 5% from previous month -->
                        53 <span class="badge rounded-pill bg-secondary">+18%<span class="visually-hidden">Change from last month</span></span>
                    </span>
                </a>
                <a class="row text-body py-2 border-bottom" href="index.php?view=notice&id=">
                    <span class="col-7">
                    ...
                    <span class="col-1" aria-label="Total Occurrences">
                        <!-- Add notice if change is over 5% from previous month -->
                        45 <span class="badge rounded-pill bg-secondary">+12%<span class="visually-hidden">Change from last month</span></span>
                    </span>
    ...
    <div class="col">
        <div class="card py-2 px-4 my-2 h-100 table-responsive">
            ...
            <div class="mb-2">
                ...
                <a class="row text-body py-2 border-bottom" href="index.php?view=page&id=">
                    <span class="col-7">
                        tulane.edu/home
                    </span>
